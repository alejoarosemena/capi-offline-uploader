...
export function UploadPage() {
    ...
    return (_jsxs("div", { className: "container", children: [_jsxs("header", { className: "header", children: [_jsx("img", { src: "/logo.png", alt: "Logo", className: "logo" }), _jsx("h1", { className: "title", children: "CAPI Offline CSV Uploader" }), _jsx("p", { className: "subtitle", children: "Sube tus ventas offline a Meta Conversions API" }), import.meta.env.DEV && (_jsxs("div", { style: {
                            background: '#fef3c7',
